...
== Screenshots ==
1. TOTP setup in WooCommerce "My Account" page.
2. TOTP activation after login.
3. Recovery Keys displayed (once).
4. Recovery Keys generation button.
5. Login screen with TOTP challenge.
6. Backend TOTP activation page.
7. Backend TOTP settings page.
8. Backend TOTP – Remove TOTP for a particular user from their profile in Users page.
